    ...
    <>
      ...
      <section>
        ...
        >
          ...
          >
            All Package's ( Total : {data?.length} )
          </span>
          <button
            onClick={() => {
              setModalShow(true);
        ...
        <section className="sectionCont">
          {data?.length === 0 || !data ? (
            ...
            <>
              <Filter setQuery={setQuery} placeholder={"Search By Title"} />
