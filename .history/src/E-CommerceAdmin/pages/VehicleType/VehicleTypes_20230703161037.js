...
const VehicleTypes = () => {
  ...
  const fetchData = async () => {
    try {
      const { data } = await axios.get("https://gadi-driver-u8ym.vercel.app/api/v1/vehicletype");
      setData(data.data);
    } catch (e) {
      console.log(e);
    }
  ...
  const deleteHandler = async (id) => {
    try {
      const { data } = await axios.delete(`https://gadi-driver-u8ym.vercel.app/api/v1/vehicletype/${id}`);
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const postHandler = async (e) => {
      e.preventDefault();
      try {
        const { data } = await axios.post("https://gadi-driver-u8ym.vercel.app/api/v1/vehicletype" , {vehicletype});
    ...
    const EditHandler = async (e) => {
      e.preventDefault();
      try {
        const { data } = await axios.post(`https://gadi-driver-u8ym.vercel.app/api/v1/vehicletype/${id}` , {vehicletype});
        toast.success(data.message);
        fetchData();
        props.onHide();
      } catch (e) {
