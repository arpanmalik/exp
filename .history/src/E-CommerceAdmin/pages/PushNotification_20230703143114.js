        ...
        <Modal.Body>
          <Form onSubmit={postHandler}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Select aria-label="Default select example" onChange={(e) => setFeaturedJob(e.target.value)}>
                <option></option>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Select aria-label="Default select example" onChange={(e) => setRefreshJob(e.target.value)}>
                <option></option>
                <option value={true}>True</option>
                <option value={false}>False</option>
              </Form.Select>
